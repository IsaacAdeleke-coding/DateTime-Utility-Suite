...
int main() {
    ...
    cout << "DateTime 1: " << dt1.toString() << endl;
    cout << "DateTime 2: " << dt2.toString() << endl;

    dt1.adjustToTimeZone(0); // Convert to UTC
    cout << "DateTime 1 (Converted to UTC): " << dt1.toString() << endl;

    cout << "Day of the Week (dt2): " << dt2.dayOfWeek() << endl;

    cout << "Serialized dt1: " << dt1.serialize() << endl;
    DateTime dt3 = DateTime::deserialize("2023-12-10T23:59:59Z-300");
    cout << "Deserialized dt3: " << dt3.toString() << endl;
